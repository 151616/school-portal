...
export default function AdminDashboard() {
  ...
  // Handle adding a new user invite
  const handleAddUser = async () => {
    if (!email) return alert("Enter email!");

    // 1️⃣ Check if email already has an invite
    ...
    // 2️⃣ Check if email already exists as a user
    ...
    // 4️⃣ Push new invite to Firebase
